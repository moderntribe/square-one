...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreReady = __webpack_require__(1);
	
	var _coreReady2 = _interopRequireDefault(_coreReady);
	
	(0, _coreReady2['default'])();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewportDims = __webpack_require__(7);
	...
	var events = new _utilsEvents2['default']();
	...
	function bind_events() {
		...
		events.on(window, 'resize', _.debounce(_resize2['default'], 200, false));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function resize() {
		...
		_utilsEvents2['default'].trigger({ event: 'modern_tribe/resize_executed', native: false });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Events = (function (_Utils) {
		...
		_createClass(Events, [{
			key: 'on',
			value: function on(el, name, handler) {
...
/***/ function(module, exports) {
	...
	var Utils = function Utils(options) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verge = __webpack_require__(8);
	
	var _verge2 = _interopRequireDefault(_verge);
	
	var _configState = __webpack_require__(9);
	
	var _configState2 = _interopRequireDefault(_configState);
	
	var _configOptions = __webpack_require__(10);
	
	function viewport_dims() {
	
		_configState2['default'].v_height = _verge2['default'].viewportH();
		_configState2['default'].v_width = _verge2['default'].viewportW();
	
		if (_configState2['default'].v_width >= _configOptions.MOBILE_BREAKPOINT) {
			_configState2['default'].is_desktop = true;
			_configState2['default'].is_mobile = false;
		} else {
			_configState2['default'].is_desktop = false;
			_configState2['default'].is_mobile = true;
		}
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resized = function resized() {
		return console.log(_configState2['default'].v_width);
	};
