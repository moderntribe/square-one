...
function tribe_post_nav() {
	...
	<nav class="post-navigation" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
		<h3 class="visuallyhidden">Post Pagination</h3>
		<ul>
...
function tribe_paging_nav() {
	...
	<nav class="loop-navigation" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
		<h3 class="visuallyhidden">Posts Pagination</h3>
		<ul>
