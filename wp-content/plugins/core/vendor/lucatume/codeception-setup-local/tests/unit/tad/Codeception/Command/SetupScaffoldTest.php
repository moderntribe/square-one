...
namespace tad\Codeception\Command\Tests\Unit;


use tad\Codeception\Command\SetupScaffold;
...
class SetupScaffoldTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        if (!self::$distFileWasThere && file_exists(codecept_root_dir('codeception.dist.yml'))) {
    ...
    public function it_should_be_instantiatable()
    {
        ...
        $this->assertInstanceOf('tad\Codeception\Command\SetupScaffold', $sut);
    }
