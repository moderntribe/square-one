<?php
class tad_Arg_Check_OrFailingTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var tad_Arg_Check
     */
    ...
    {
        $this->tad_arg_check = new tad_Arg_Check(new tad_Arg_Check_OrFailingState);
    }
     ...
     * @covers tad_Arg_Check_OrFailingState::pass
     ...
     * @covers tad_Arg_Check_OrFailingState::fail
     ...
     * @covers tad_Arg_Check_OrFailingState::or_condition
