...
class Section_Manager extends Section_Role {
	const NAME = 'section_manager';

	public function get_label() {
		return __( 'Section Manager', 'tribe' );
	}

	public function general_capabilities(): array {
		$user_caps = parent::general_capabilities();

		$section_taxonomy = get_taxonomy( Section::NAME );

		$user_caps[ $section_taxonomy->cap->manage_terms ] = true;
