...
class Content_Columns_Model extends Base_Model {
	...
	public function get_data(): array {
		return [
			...
			Content_Columns_Block_Controller::CTA         => $this->get_cta_args(
				$this->get( Content_Columns::CTA, [] )
			),
			Content_Columns_Block_Controller::CLASSES     => $this->get_classes(),
			Content_Columns_Block_Controller::COLUMNS     => $this->get_rows(),
			Content_Columns_Block_Controller::LAYOUT      => $this->get(
				Content_Columns::LAYOUT,
				Content_Columns::LAYOUT_LEFT
			),
		];
	}
