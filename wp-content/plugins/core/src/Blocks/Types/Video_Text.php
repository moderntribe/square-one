...
class Video_Text extends Block_Type_Config {
	public const NAME = 'tribe/video-text';
	...
	private function media_area(): Content_Section {
		return $this->factory->content()->section()
			...
			->add_field(
				$this->factory->content()->field()->embed( self::EMBED )
					->set_label( __( 'Video Embed', 'tribe' ) )
					->build()
			)
			->build();
	}
