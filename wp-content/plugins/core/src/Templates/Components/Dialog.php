...
class Dialog extends Component {
	...
	const CONTENT_OVERLAY_INNER_CLASSES = 'content_overlay_inner_classes';
	...
	protected function parse_options( array $options ): array {
		$defaults = [
			...
			static::CONTENT_OVERLAY_INNER_CLASSES => [],
	...
	public function get_data(): array {
		$data = [
			...
			static::CONTENT_OVERLAY_INNER_CLASSES => $this->merge_classes( [ 'c-dialog__overlay-inner' ], $this->options[ static::CONTENT_OVERLAY_INNER_CLASSES ], true ),
