...
class Extensible_Walker_Nav_Menu extends \Walker_Nav_Menu {
	 ...
	 * @param object $args   An array of arguments. @see wp_nav_menu()
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		/**
		 * Filter the HTML attributes applied to a menu item's li element.
		 *
		 * @since 3.6.0
		 * @since 4.1.0 The `$depth` parameter was added.
		 *
		 ...
		 * @param int    $depth Depth of menu item. Used for padding.
		 */
		$li_atts = apply_filters( 'nav_menu_li_attributes', $li_atts, $item, $args, $depth );
