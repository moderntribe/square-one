...
<div class="social-follow">
	...
	<ul class="social-follow__list">
		<?php foreach ( $c->get_social_links() as $item ) : ?>
			<li class="social-follow__item social-follow__item--<?php echo esc_attr( sanitize_html_class( $item->class ) ); ?>">
				<a href="<?php echo esc_url( $item->url ); ?>" class="social-follow__anchor" rel="me noopener"
				   title="<?php echo esc_attr( $item->title ); ?>" target="_blank">
					<i class="icon icon-<?php echo esc_attr( sanitize_html_class( $item->class ) ); ?>"></i>
